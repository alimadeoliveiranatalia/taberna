...
$sql='select cod_prod, nome, preco_venda from tb_produto where categoria like \'Higiene%\'';
$prodHP=$mysqli->query($sql);
			...
			<div class="row">
				<div class="col-md-9">
					<div class="products-heading">
						<h2>HIGIÊNIE PESSOAL</h2>
					</div>	<!-- End of /.Products-heading -->
					<div class="product-grid">
					    <ul>
							<?php while($soHP=$prodHP->fetch_assoc()):?>
					        <li>
					            <div class="products">
									<a href="#">
										<img src="../web/img/img_produtos/<?=$soHP['cod_prod']?>.png" alt="">
									</a>
									<a href="#">
										<h4><?=$nome=$soHP['nome'];?></h4>
										<p class="price">Apenas: R$ <?=$preco=$soHP['preco_venda'];?></p>
										<div>
											<a class="view-link shutter" href="levar.php?cod_prod=<?=$soHP['cod_prod'];?>">
