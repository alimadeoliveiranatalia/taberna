...
$sql='select cod_prod, nome, preco_venda from tb_produto where categoria like \'bebidas%\'';
$prodBebidas=$mysqli->query($sql);
			...
			<div class="row">
				<div class="col-md-9">
					...
					<div class="product-grid">
					    <ul>
							<?php while($soBebidas=$prodBebidas->fetch_assoc()):?>
					        <li>
					            <div class="products">
									<a href="#">
										<img src="../web/img/img_produtos/<?=$soBebidas['cod_prod']?>.png" alt="">
									</a>
									<a href="#">
										<h4><?=$nome=$soBebidas['nome'];?></h4>
										<p class="price">Apenas: R$ <?=$preco=$soBebidas['preco_venda'];?></p>
										<div>
											<a class="view-link shutter" href="levar.php?cod_prod=<?=$soBebidas['cod_prod'];?>">
