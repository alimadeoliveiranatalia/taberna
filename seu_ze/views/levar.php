					...
					<div class="product-grid">
					    <ul>
					        ...
					        <li>
					            <div class="products">
									<a href="#">
										<img src="img_produtos/<?=$mercadoriaLevar['cod_prod']?>.png" alt="">
									</a>
									<a href="#">
										<h4><?=$nome=$mercadoriaLevar['nome'];?></h4>
										<p class="price">Apenas: R$ <?=$preco=$mercadoriaLevar['preco_venda'];?></p>
										<p class="price">Vencimento: <?=$venc=$mercadoriaLevar['vencimento'];?></p>
                                        <div>
											<a class="view-link shutter" href="#">
												<i class="fa fa-plus-circle"></i>Adcionar este item no carrinho?
											</a>
										</div>
